 ...
 */
export async function sendMail({ to, subject, html, tags, headers }) {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p class="intro-text">Thank you for creating an account with QuickFynd. We're excited to have you as part of our community!</p>
          ...
          <div class="button-container">
            <a href="${process.env.NEXT_PUBLIC_BASE_URL || 'https://quickfynd.com'}" class="button">Start Shopping</a>
          </div>

          <div class="support-section">
            <p>💬 <strong>Need help?</strong> Our support team is here for you! Contact us at <a href="mailto:support@quickfynd.com">support@quickfynd.com</a></p>
          </div>
        </div>
        <div class="footer">
