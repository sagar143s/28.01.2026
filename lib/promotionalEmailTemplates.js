  ...
  return `
    <div style="background: #111827; padding: 32px 30px; text-align: center; color: #9ca3af;">
      <div style="margin-bottom: 16px;">
        <div style="display: inline-block; background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 8px 12px; border-radius: 6px; margin-bottom: 8px;">
          <span style="font-size: 24px; font-weight: 700; color: #ffffff;">⚡ QuickFynd</span>
        </div>
        <p style="margin: 8px 0 0 0; font-size: 13px; color: #6b7280;">Smart Shopping, Smart Savings</p>
      </div>
      <p style="margin: 12px 0 8px 0; font-size: 14px;">© ${new Date().getFullYear()} Quickfynd. All rights reserved.</p>
      <p style="margin: 0 0 12px 0; font-size: 12px;">
        <a href="${baseUrl}/help" style="color: #9ca3af; text-decoration: none;">Help Center</a> | 
        <a href="${baseUrl}/about-us" style="color: #9ca3af; text-decoration: none;">About Us</a> | 
        <a href="${baseUrl}/profile/settings" style="color: #9ca3af; text-decoration: none;">Manage Preferences</a>
      </p>
      <p style="margin: 12px 0 0 0; font-size: 11px; color: #6b7280;">
        You received this email because you have an account with QuickFynd.<br/>
        <a href="${unsubscribeUrl}" style="color: #9ca3af; text-decoration: underline;">Unsubscribe from promotional emails</a>
      </p>
    </div>
  `;
}
